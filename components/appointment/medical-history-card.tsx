    ...
    <Card className="shadow-none">
      <div className="space-y-6 pt-4">
        <div className="flex gap-x-6 justify-between">
          <div>
            <span className="text-sm text-gray-500">ID du rendez-vous</span>
        ...
        <div>
          <span className="text-sm text-gray-500">Symptômes</span>
        ...
        <div>
          <span className="text-sm text-gray-500">Note additionnelle</span>

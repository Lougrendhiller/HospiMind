      ...
      >
        ...
        <td>
          <div className="flex items-center gap-x-2">
            ...
            <Link href={`/record/appointments/${item?.id}`}>Voir tout</Link>
          </div>
        </td>
      </tr>
    );
  ...
  return (
    <div className="bg-white rounded-xl p-2 2xl:p-4">
      <div className="flex justify-between items-center">
        <h1 className="text-lg font-semibold">Rendez-vous récents</h1>

        <Button asChild variant={"outline"}>
          <Link href="/record/appointments">Tout voir</Link>
        </Button>
      </div>

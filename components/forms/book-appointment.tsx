...
const TYPES = [
  ...
  { label: "Bilan général", value: "General Check Up" },
  { label: "Antenatal", value: "Antenatal" },
  { label: "Maternité", value: "Maternity" },
  { label: "Analyse laboratoire", value: "Lab Test" },
  { label: "ANT", value: "ANT" },
];
  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        ...
        >
          <UserPen size={16} /> Prendre rendez-vous
        </Button>
      </SheetTrigger>
      ...
      <SheetContent className="rounded-xl rounded-r-2xl md:h-p[95%] md:top-[2.5%] md:right-[1%] w-full">
        {loading ? (
          ...
          <div className="h-full overflow-y-auto p-4">
            <SheetHeader>
              <SheetTitle>Prendre rendez-vous</SheetTitle>
            </SheetHeader>
            ...
            <Form {...form}>
              ...
              >
                ...
                <CustomInput
                  ...
                  placeholder="Sélectionner un type de rendez-vous"
                />

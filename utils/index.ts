...
export function calculateDiscount({
  ...
  if (discount != null && discountPercentage != null) {
    throw new Error(
      "Veuillez fournir soit un montant de remise, soit un pourcentage de remise, mais pas les deux."
    );
  }
  ...
  if (discount != null) {
    ...
    throw new Error(
      "Veuillez fournir soit un montant de remise, soit un pourcentage de remise."
    );
  }
}

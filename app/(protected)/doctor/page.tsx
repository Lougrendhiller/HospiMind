...
const DoctorDashboard = async () => {
  ...
  const cardData = [
    ...
    },
    {
      ...
      note: "Nombre total d'infirmiers",
      link: "",
    },
    {
      title: "Rendez-vous",
      ...
      note: "Nombre total de rendez-vous",
    ...
    },
    {
      ...
      note: "Nombre total de consultations",
      link: "/record/appointments",
    },
  ];
        ...
        <div className="bg-white rounded-xl p-4 mb-8">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-lg xl:text-2xl font-semibold">
              Bienvenue, Dr {user?.firstName}
            </h1>
            <Button size="sm" variant="outline" asChild>
              <Link href={`/record/doctors/${user?.id}`}>Voir le profil</Link>
            </Button>
          </div>
